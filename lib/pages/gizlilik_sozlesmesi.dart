...
class GizlilikSozlesmesi extends StatefulWidget {
  @override
  State<GizlilikSozlesmesi> createState() => _GizlilikSozlesmesiState();
}

class _GizlilikSozlesmesiState extends State<GizlilikSozlesmesi> {
  String privacyText =
